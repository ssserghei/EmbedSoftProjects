 ...
 *      Author: kiran
 */
/*lucreaza . genereaza 4 fregvente
 * */
	 //2. Configure gpios to behave as timer2 channel 1,2,3 and 4
  /* PA0 --> TIM2_CH1 		//to produce 500Hz
	 PA1 --> TIM2_CH2 		//to produce 1000HZ
	 PB10 --> TIM2_CH3 		//to produce 2000Hz
	 PB2 --> TIM2_CH4 */ 	//to produce 4000Hz
