...
1. Configure the mode (standart or fast mode)
2. Configurte the speed of serial clock (SCL)
3. Configurte the device address (Aplicable when the device is slave)
4.Enable the acking
